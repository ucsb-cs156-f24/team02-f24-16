...
public class RecommendationRequestIT extends WebTestCase {
    ...
    public void admin_user_can_create_recommendationRequest() throws Exception {
        ...
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-requesterEmail")).hasText("Chucknorris@ucsb.edu");
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-professorEmail")).hasText("sickguyFoo@ucsb.edu");
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-explanation")).hasText("Just need my stuff.");
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-dateRequested")).hasText("2012-12-12T04:28:00");
        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-dateNeeded")).hasText("2013-12-12T04:28:00");
    }
}