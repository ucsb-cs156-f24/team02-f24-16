...
public class UCSBOrganizationIT {
        ...
        public void test_that_logged_in_user_can_get_by_orgCode_when_the_orgCode_exists() throws Exception {
                ...
                UCSBOrganization organization = UCSBOrganization.builder()
                                .orgCode("DRC")
                                .orgTranslationShort("Dark Reunion")
                                .orgTranslation("Dark Reunion Club")
                                .inactive(false)
                                .build();
                ...
                // act
                MvcResult response = mockMvc.perform(get("/api/ucsborganization?orgCode=DRC"))
        ...
        public void an_admin_user_can_post_a_new_organization() throws Exception {
                ...
                UCSBOrganization organization1 = UCSBOrganization.builder()
                                .orgCode("TPC")
                                .orgTranslationShort("Telepathy")
                                .orgTranslation("The Telepathy Club")
                                .inactive(true)
                                .build();

                // act
                MvcResult response = mockMvc.perform(
                                post("/api/ucsborganization/post?orgCode=TPC&orgTranslationShort=Telepathy&orgTranslation=The Telepathy Club&inactive=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
