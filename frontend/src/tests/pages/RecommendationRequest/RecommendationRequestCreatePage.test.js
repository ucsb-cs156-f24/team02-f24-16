...
describe("RecommendationRequestCreatePage tests", () => {
  ...
  test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
    ...
    fireEvent.change(professorEmailField, {
      target: { value: "rihanna.fenty@fentymusic.com" },
    });
    ...
    fireEvent.change(dateRequestedField, {
      target: { value: "2024-10-31T15:30:00" },
    });
    fireEvent.change(dateNeededField, {
      target: { value: "2024-11-15T15:30:00" },
    });
    ...
    expect(mockToast).toBeCalledWith(
      "New RecommendationRequest Created - id: 1 requestor: jaydenjardine@cs.ucsb.edu professor: rihanna.fenty@fentymusic.com explanation: Requesting your participation in a university event focusing on the influence of Caribbean music in pop culture. status: false date requested: 2024-10-31T15:30:00 date needed by 2024-11-15T15:30:00",
    );
