...
|---------------------------|--------------|-------------|
| UCSBDiningCommonsMenuItem |    Kelly     |  li-kelly   |
| UCSBOrganization          |    Claire    | cs11111111  |
| RecommendationRequest     |    Jayden    | jayster7101 |
| MenuItemReview            |    Rohan     | rohanpreetam|
| HelpRequest               |    Tiffany   | ttnguyen908 |
| Articles                  |    Shriaan   | Salshriaan  |
